...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
        <div class="right">
			...
			<br/>
			<div class="providerTable" id="view" style="display: none" >
				<label style="font-size: 20px">用户编号：<span id="code"></span></label><br/><br/>
				<label style="font-size: 20px">用户名称：<span id="name"></span></label><br/><br/>
				<label style="font-size: 20px">出生日期：<span id="birthdate"></span></label><br/><br/>
			</div>
    </section>
<!--点击删除按钮后弹出的页面-->
