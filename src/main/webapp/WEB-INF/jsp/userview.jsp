...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p><strong>证件照：</strong><span><img src="${pageContext.request.contextPath }/photo/${user.idPicPath}" width="50px"/></span></p>
            <p><strong>工作证：</strong><span><img src="${pageContext.request.contextPath }/photo/${user.workPicPath}"width="50px"/></span></p>
